...
```sh
nix run github:gqf2008/walgit-d1 -- --config walgit.toml     # or: podman build -f Containerfile .
```

The repository is at **github.com/gqf2008/walgit-d1**, MIT licensed. `README.md` is the introduction; `AGENTS.md` is
